...
export default function About({ onNavigate }: AboutProps) {
  const team = [
    ...
    { name: 'Saidur Ahmed',    role: 'Voice Research Lead',   desc: 'Researched voice-based emotion detection and feature extraction. Explored prosodic and acoustic features for mental health analysis.', emoji: '🎙️', color: '#34d399', gradient: 'rgba(52,211,153,0.08)' },
